...
class Dentist(models.Model):
    ...
    profile  = models.ImageField(upload_to="DentistImage",blank=True, null=True)
    dentist_image = models.ImageField(upload_to="Image",blank=True, null=True)
...
class DentistConnect(models.Model):
