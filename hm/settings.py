...
SECRET_KEY = 'django-insecure-vc^(!rl1d!4n(f4i@aybjzn#tomr@vb$$^=bt0-v69i$=q&!8i'
...
MIDDLEWARE = [
    ...
    'home.redirect_middleware.RedirectToNewUrl',
...
ASGI_APPLICATION = 'hm.asgi.application'
...
# EMAIL_HOST_PASSWORD='ooby stkw cvkn wzwy'
# ACCOUNT_EMAIL_VERIFICATION ='none'
...
# EMAIL_USE_TLS = True
# EMAIL_USE_SSL= False
# EMAIL_HOST_USER = 'noreply@studyatmit.com'
# EMAIL_HOST_PASSWORD = 'Ppjerry@123@'
# EMAIL_PORT = 587
...
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY") or os.getenv("GEMINI_API_KEY_NEW")
